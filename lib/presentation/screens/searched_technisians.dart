...
import 'package:repairo_app_new/data/models/searched_technicians_model.dart';
import 'package:repairo_app_new/presentation/widgets/technisians_widget.dart';

class SearchedTechs extends StatelessWidget {
  SearchedTechs({super.key});
  ...
  Widget builditemsList() {
    return ListView.builder(
      ...
      itemBuilder: (ctx, index) {
        return TechnisiansWidget(technisians: searchresult[index]);
      },
    );
  }
}
